...
export default function FeedPage() {
  ...
  return (
    <div className="h-[100dvh] overflow-hidden bg-[#050816] text-white">
      ...
      <header className="fixed left-0 right-0 top-0 z-40 border-b border-white/10 bg-[#050816]/85 px-4 py-3 backdrop-blur-xl">
      ...
      <main className="h-[100dvh] snap-y snap-mandatory overflow-y-scroll px-4 pb-28 pt-24">
        <div className="mx-auto max-w-md snap-start space-y-4 pb-5">
        ...
        {loading ? (
          ...
          posts.map((post, index) => (
            <div key={post.id} className="mx-auto flex min-h-[100dvh] max-w-md snap-start items-center py-5">
